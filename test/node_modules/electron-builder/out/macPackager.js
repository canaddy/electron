...
class MacPackager extends (_platformPackager || _load_platformPackager()).PlatformPackager {
    ...
    sign(appOutDir, masOptions) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            const masQualifier = masOptions == null ? null : masOptions.identity || _this3.platformSpecificBuildOptions.identity;
            let name = yield (0, (_codeSign || _load_codeSign()).findIdentity)(masOptions == null ? "Developer ID Application" : "3rd Party Mac Developer Application", masOptions == null ? _this3.platformSpecificBuildOptions.identity : masQualifier, keychainName);
            if (name == null) {
